...
(define (appHelper [func : Value] [arg : Value] [env : Env]) : Value
; insert key value pair into environment where key is param of v-fun that is passed in as func and value is arg
