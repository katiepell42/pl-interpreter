...
;; Straight-up stolen from https://cs.brown.edu/courses/cs173/2021/implementation-specs/interp/support.rkt
...
(define (interp-error->string interp-error)
  (type-case InterpError interp-error
    ...
    [(err-unbound-var name) (~a name " is unbound")]
